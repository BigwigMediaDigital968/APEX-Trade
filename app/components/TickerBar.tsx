...
export default function TickerBar() {
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Live ticker */}
      <div className="bg-[#131929]/90 border-y border-border-main py-3 overflow-hidden">
      ...
      {/* Trust bar */}
      <div className="px-6 py-5 flex items-center justify-center gap-10 flex-wrap border-b border-border-main/80">
        {brands.map((brand) => (
          <div
            key={brand}
