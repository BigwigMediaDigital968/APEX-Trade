...
export default function HowItWorksSection() {
  return (
    <section
      id="how-it-works"
      className="py-24 px-6 relative bg-[linear-gradient(180deg,transparent_0%,rgba(61,107,255,0.04)_50%,transparent_100%)]"
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Steps */}
        <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-0 relative">
          {/* Connector line */}
        ...
        <div className="text-center mt-16">
          <a href="#" className="btn-primary text-[1rem] no-underline">
            Start Your Journey
