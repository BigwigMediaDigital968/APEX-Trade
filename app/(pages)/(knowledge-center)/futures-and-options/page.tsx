...
export default function FeaturesOptions() {
  return (
    <>
      <HeroSection
        title="Futures and Options Trading India"
        tag="Trade Smarter with Apex Trade"
        backgroundImage="https://images.unsplash.com/photo-1589560989620-61bf48e97abb?q=80&w=1974&auto=format&fit=crop"
        description="With Apex Trade, traders gain access to a powerful online trading platform designed to simplify F&O trading through real-time market insights, advanced analytics, and fast order execution."
      />
