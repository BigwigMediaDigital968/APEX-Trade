...
import MarginTradingPage from "./component/MarginTrading";
import AboutMargin from "./component/AboutMargin";
import FAQs from "@/app/components/Faqs";
import { marginTradingFaqs } from "@/app/FaqsData";
...
export default function MarginTrading() {
  ...
  return (
    <>
      <HeroSection
        title="Margin Trading India"
        tag="Amplify Your Market Opportunities with Apex Trade"
      ...
      <TestimonialsSection />
      <FAQs
        title={marginTradingFaqs.title}
        description={marginTradingFaqs.description}
        faqs={marginTradingFaqs.faqs}
      />
    </>
  );
}
