...
export const blogData: Blog[] = [
{
    ...
    description: "Confused about which chart to use for intraday trading? This complete guide explains the best time frame for intraday trading — from 1-minute to 60-minute charts — so you can trade smarter every session.",
